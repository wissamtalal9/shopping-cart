...
console.log(cart)
let Contents_cart = document.getElementById('cartContents');
...
function populateForm() {
    ...
    for (let i in Product.allProducts) {
        ...
        li_1.innerHTML = `you pick ${cart.items[i].product} and your quantity  ${cart.items[i].quantity}`;
        Contents_cart.appendChild(li_1);
        count ++
        }
